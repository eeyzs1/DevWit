...
**最新版本 v0.7.20 · 免费软件 · MIT 协议**（全部构建产物见 [Releases](https://github.com/eeyzs1/DevWit/releases)）

### Windows（x64）

直接下载：[DevWit.Setup.0.7.20.exe](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit.Setup.0.7.20.exe)（NSIS 安装包，可选安装目录，支持 `/S` 静默安装）。
...
winget（microsoft/winget-pkgs#407506、#422497、#425984 已先后合并，最新 v0.7.0 已上线；v0.7.20 清单已备于 distribution/winget 待提交）：
...
或直接下载：[DevWit-0.7.20-arm64.dmg](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit-0.7.20-arm64.dmg)（Intel Mac 暂无构建）。

### Linux（x64）

- AppImage（支持应用内自动更新）：[DevWit-0.7.20.AppImage](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit-0.7.20.AppImage)，下载后 `chmod +x` 直接运行
- Debian/Ubuntu：[devwit_0.7.20_amd64.deb](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/devwit_0.7.20_amd64.deb)，`sudo dpkg -i` 安装
