...
const zhCN = {
  ...
  "trace.type.request_rewrite": "请求改写",
  ...
  // ---- 设置 · MCP 工具（AC17）----
  "mcp.title": "MCP 服务器（stdio / http · 修改热生效）",
  "mcp.hint":
    "连接外部 MCP 服务器（stdio 本地子进程或 http 远程端点），其工具以 mcp__服务器__工具 全名提供给 Agent，调用前一律经授权门裁决。",
  "mcp.name": "显示名",
  "mcp.command": "命令",
  ...
  "mcp.requiredHttp": "ID / 显示名 / URL 必填（http 传输）",
  "mcp.transport": "传输",
  "mcp.transport.stdio": "本地进程（stdio）",
  "mcp.transport.http": "远程（Streamable HTTP）",
  "mcp.url": "URL",
  "mcp.url.placeholder": "如：https://mcp.example.com/mcp",
  "mcp.headers": "请求头（KEY=VALUE，每行一个，可留空）",
  "mcp.headers.invalid": "请求头格式错误：第 {n} 行缺少「=」",
  ...
  "err.credentialDecryptFailed": "凭证解密失败（更换系统/设备后加密密钥不可用）：请在设置 → 模型中重新录入 API Key",
  ...
  "act.tool.mcp": "远程 MCP：{name} · {transport}",
  "act.tool.endpoint": "远程端点：{url}",
  "act.tool.server": "服务器：{name} · {version}",
...
const enUS: Messages = {
  ...
  "trace.type.request_rewrite": "Request rewrite",
  ...
  "mcp.title": "MCP servers (stdio / http, hot-applied)",
  "mcp.hint":
    "Connect external MCP servers (stdio local subprocess or http remote endpoint); their tools are exposed to the Agent as mcp__server__tool and always go through the authorization gate.",
  "mcp.name": "Name",
  "mcp.command": "Command",
  ...
  "mcp.requiredHttp": "ID / name / URL are required (http transport)",
  "mcp.transport": "Transport",
  "mcp.transport.stdio": "Local process (stdio)",
  "mcp.transport.http": "Remote (Streamable HTTP)",
  "mcp.url": "URL",
  "mcp.url.placeholder": "e.g. https://mcp.example.com/mcp",
  "mcp.headers": "Headers (KEY=VALUE, one per line, optional)",
  "mcp.headers.invalid": "Invalid header line {n}: missing \"=\"",
  ...
  "err.credentialDecryptFailed": "Credential decryption failed (the encryption key is unavailable after a system/device change): please re-enter the API key in Settings → Providers",
  ...
  "act.tool.mcp": "Remote MCP: {name} · {transport}",
  "act.tool.endpoint": "Endpoint: {url}",
  "act.tool.server": "Server: {name} · {version}",
