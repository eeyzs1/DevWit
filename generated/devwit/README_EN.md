...
**Latest v0.7.20 · Free software · MIT license** (all build artifacts on the [Releases](https://github.com/eeyzs1/DevWit/releases) page)

### Windows (x64)

Direct download: [DevWit.Setup.0.7.20.exe](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit.Setup.0.7.20.exe) (NSIS installer, custom install directory, supports `/S` silent install).
...
winget (merged via microsoft/winget-pkgs#407506 / #422497 / #425984; latest v0.7.0 live — v0.7.20 manifest prepared under distribution/winget, submission pending):
...
Or download directly: [DevWit-0.7.20-arm64.dmg](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit-0.7.20-arm64.dmg) (no Intel Mac build yet).

### Linux (x64)

- AppImage (in-app auto-update): [DevWit-0.7.20.AppImage](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/DevWit-0.7.20.AppImage) — `chmod +x` and run
- Debian/Ubuntu: [devwit_0.7.20_amd64.deb](https://github.com/eeyzs1/DevWit/releases/download/v0.7.20/devwit_0.7.20_amd64.deb) — install with `sudo dpkg -i`
